// New command — `RetroAchievementsSharp scan` (a RetroAchievementsSharp extension; RAHasher 1.8.3 has no
...
internal static class ScanCommand
{
    ...
    {
        Console.WriteLine("Usage: RetroAchievementsSharp {0} [options] <path>...", Name);
        Console.WriteLine();
