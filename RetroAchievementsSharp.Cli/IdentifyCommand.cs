// New command — `RetroAchievementsSharp identify` (a RetroAchievementsSharp extension; RAHasher 1.8.3 has
...
internal static class IdentifyCommand
{
    ...
    {
        Console.WriteLine("Usage: RetroAchievementsSharp {0} <system> <file> [options]", Name);
        Console.WriteLine();
