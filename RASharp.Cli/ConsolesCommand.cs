// New command — `RASharp consoles` (a RASharp extension; RAHasher 1.8.3 has
...
/// <summary>New command — `RASharp consoles` (a RASharp extension; RAHasher 1.8.3 has no subcommands, so the legacy positional interface and its byte-exact parity surface are un</summary>
internal static class ConsolesCommand
{
    ...
    {
        Console.WriteLine("Usage: RASharp {0} [options]", Name);
        Console.WriteLine();
