// New command — `RASharp checkkeys` (a RASharp extension; RAHasher 1.8.3
...
/// <summary>New command — `RASharp checkkeys` (a RASharp extension; RAHasher 1.8.3 has no subcommands, so the legacy positional interface and its byte-exact parity surface are un</summary>
