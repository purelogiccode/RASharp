...
// `RASharp scan --match` — the JSON file produced by the
...
/// <summary>Loader for the RetroAchievements game database snapshot used by `RASharp scan --match` — the JSON file produced by the RetroAchievements.DataFetcher tool (see CSharp_</summary>
