// Tests for the `RASharp identify` subcommand (a RASharp extension — not
...
/// <summary>Tests for the `RASharp identify` subcommand (a RASharp extension — not part of the RAHasher 1.8.3 parity surface). It hashes a single file with an explicit console and r</summary>
