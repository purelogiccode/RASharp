// Tests for the `RetroAchievementsSharp consoles` subcommand (a RetroAchievementsSharp extension — not
...
/// <summary>Tests for the `RetroAchievementsSharp consoles` subcommand (a RetroAchievementsSharp extension — not part of the RAHasher 1.8.3 parity surface). It dumps the console metadata table (id, key, grou</summary>
public class TestConsoles
{
    ...
    public void ConsolesHelp()
    {
        ...
        Assert.Equal(0, exit);
        Assert.Contains("Usage: RetroAchievementsSharp consoles", stdout, StringComparison.Ordinal);
    }
