// Tests for the `RetroAchievementsSharp scan` subcommand (a RetroAchievementsSharp extension — not part
...
using RetroAchievementsSharp.Tests.Parity;

namespace RetroAchievementsSharp.Tests;

/// <summary>Tests for the `RetroAchievementsSharp scan` subcommand (a RetroAchievementsSharp extension — not part of the RAHasher 1.8.3 parity surface). The scan command enumerates real directories and h</summary>
public class TestScan : IDisposable
{
    ...
    public void ScanHelp()
    {
        ...
        Assert.Equal(0, exit);
        Assert.Contains("Usage: RetroAchievementsSharp scan", stdout, StringComparison.Ordinal);
    }
     ...
     * runs the freshly built RetroAchievementsSharp.Cli.exe) */
    ...
    public void ScanDispatchThroughCliExe()
    {
        ...
        {
            return; /* the parity harness locates RetroAchievementsSharp.Cli.exe (Windows apphost) */
        }
